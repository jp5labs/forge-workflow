...
try:
    ...
    # Fallback: if package isn't importable, provide a no-op escalation
    # so secret detection still blocks but circuit breaker won't fire
    def escalate_secret_detection(_warning):
        return {"halted": False, "count": 0}
